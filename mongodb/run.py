...
# config system
app = Flask(__name__)
app.config.update(dict(SECRET_KEY='dst5wukhsyurshjmuxy987'))
client = MongoClient('mongodb+srv://test:test@cluster0.kw4id.mongodb.net/Employee?retryWrites=true&w=majority')
